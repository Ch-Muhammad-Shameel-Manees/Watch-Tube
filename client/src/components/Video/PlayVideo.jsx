        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <div className="mt-2 flex flex-wrap items-center gap-3">
              <Button
                type="button"
                className={`inline-flex items-center gap-1 rounded-full px-2 py-1 text-xs transition-colors ${isCommentLiked ? (theme === 'dark' ? 'bg-white text-gray-950' : 'bg-gray-950 text-white') : (theme === 'dark' ? 'bg-white text-gray-950' : 'bg-gray-950 text-white')}`}
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-2">
                  <Button
                    ...
                    className={`inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium transition-colors ${Boolean(video?.isLiked) ? (theme === 'dark' ? 'bg-white text-gray-950' : 'bg-gray-950 text-white') : (theme === 'dark' ? 'bg-white text-gray-950' : 'bg-gray-950 text-white')}`}
                  >
